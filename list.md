...
| # | 功能 | 说明 | 状态 |
|---|------|------|:--:|
| D1 | TG 提醒随机延迟 | 批量发送时随机延迟 0-15min 启动 + 每条消息间 0-30s 间隔，防止容器平台判定批量外呼/滥用封号 | ✅ |
| D2 | 中英文切换 (i18n) | 轻量 Context 手写 i18n，15 个翻译分组，localStorage 持久化，LandingPage + App 双语言切换按钮 | ✅ |
| D3 | 底部合规声明 | LandingPage + App Footer 挂免责声明简短版，点击弹出完整版弹窗，中英文自动切换 | ✅ |
| D4 | 一键导出/导入 | JSON 格式导出 tasks + checkin_logs，支持合并/覆盖两种导入模式，JWT 认证 | ✅ |
